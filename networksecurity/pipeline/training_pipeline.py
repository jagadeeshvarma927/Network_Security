...
class TrainingPipeline:
    ...
    def run_pipeline(self):
        try:
            ...
            data_model_trainer = self.start_data_transformation(data_validation_artifact=data_validation_artifact)

            print(f"Data Transformation artifact: {data_model_trainer}")
